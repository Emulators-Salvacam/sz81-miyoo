...
//	hotspots[HS_RUNOPTS3_JDEADZ_DN].gid = HS_GRP_RUNOPTS3;
//	hotspots[HS_RUNOPTS3_JDEADZ_UP].gid = HS_GRP_RUNOPTS3;
 	hotspots[HS_RUNOPTS3_RUNOPTS3].gid = HS_GRP_RUNOPTS3;
	for (count =  HS_RUNOPTS3_JOY_CFG_LTRIG; count <= HS_RUNOPTS3_EXIT; count++)
		hotspots[count].gid = HS_GRP_RUNOPTS3;
       	for (count = HS_RUNOPTS3_KEY_1; count <= HS_RUNOPTS3_KEY_SPACE; count++)
       		hotspots[count].gid = HS_GRP_RUNOPTS3;
	hotspots[HS_RUNOPTS3_JOY_CFG_LTRIG].remap_id = SDLK_a;
 	hotspots[HS_RUNOPTS3_JOY_CFG_LTRIG].flags |= HS_PROP_SELECTED;	/* Default selected */
...
/*	
	hotspots[HS_RUNOPTS3_KEY_1].remap_id = SDLK_1;
	hotspots[HS_RUNOPTS3_KEY_2].remap_id = SDLK_2;
	hotspots[HS_RUNOPTS3_KEY_3].remap_id = SDLK_3;
	hotspots[HS_RUNOPTS3_KEY_4].remap_id = SDLK_4;
	hotspots[HS_RUNOPTS3_KEY_5].remap_id = SDLK_5;
	hotspots[HS_RUNOPTS3_KEY_6].remap_id = SDLK_6;
	hotspots[HS_RUNOPTS3_KEY_7].remap_id = SDLK_7;
	hotspots[HS_RUNOPTS3_KEY_8].remap_id = SDLK_8;
	hotspots[HS_RUNOPTS3_KEY_9].remap_id = SDLK_9;
	hotspots[HS_RUNOPTS3_KEY_0].remap_id = SDLK_0;
	hotspots[HS_RUNOPTS3_KEY_Q].remap_id = SDLK_q;
	hotspots[HS_RUNOPTS3_KEY_W].remap_id = SDLK_w;
	hotspots[HS_RUNOPTS3_KEY_E].remap_id = SDLK_e;
	hotspots[HS_RUNOPTS3_KEY_R].remap_id = SDLK_r;
	hotspots[HS_RUNOPTS3_KEY_T].remap_id = SDLK_t;
	hotspots[HS_RUNOPTS3_KEY_Y].remap_id = SDLK_y;
	hotspots[HS_RUNOPTS3_KEY_U].remap_id = SDLK_u;
	hotspots[HS_RUNOPTS3_KEY_I].remap_id = SDLK_i;
	hotspots[HS_RUNOPTS3_KEY_O].remap_id = SDLK_o;
	hotspots[HS_RUNOPTS3_KEY_P].remap_id = SDLK_p;
	hotspots[HS_RUNOPTS3_KEY_A].remap_id = SDLK_a;
	hotspots[HS_RUNOPTS3_KEY_S].remap_id = SDLK_s;
	hotspots[HS_RUNOPTS3_KEY_D].remap_id = SDLK_d;
	hotspots[HS_RUNOPTS3_KEY_F].remap_id = SDLK_f;
	hotspots[HS_RUNOPTS3_KEY_G].remap_id = SDLK_g;
	hotspots[HS_RUNOPTS3_KEY_H].remap_id = SDLK_h;
	hotspots[HS_RUNOPTS3_KEY_J].remap_id = SDLK_j;
	hotspots[HS_RUNOPTS3_KEY_K].remap_id = SDLK_k;
	hotspots[HS_RUNOPTS3_KEY_L].remap_id = SDLK_l;
	hotspots[HS_RUNOPTS3_KEY_NEWLINE].remap_id =SDLK_RETURN;
	hotspots[HS_RUNOPTS3_KEY_SHIFT].remap_id = SDLK_SHIFT;
	hotspots[HS_RUNOPTS3_KEY_Z].remap_id = SDLK_z;
	hotspots[HS_RUNOPTS3_KEY_X].remap_id = SDLK_x;
	hotspots[HS_RUNOPTS3_KEY_C].remap_id = SDLK_c;
	hotspots[HS_RUNOPTS3_KEY_V].remap_id = SDLK_v;
	hotspots[HS_RUNOPTS3_KEY_B].remap_id = SDLK_b;
	hotspots[HS_RUNOPTS3_KEY_N].remap_id = SDLK_n;
	hotspots[HS_RUNOPTS3_KEY_M].remap_id = SDLK_m;
	hotspots[HS_RUNOPTS3_KEY_DOT].remap_id = SDLK_0;
	hotspots[HS_RUNOPTS3_KEY_SPACE].remap_id = SDLK_0;
*/	
	#else
	/* Initialise runtime options hotspots */
	...
	if (gid & HS_GRP_RUNOPTS_ALL) {
		...
		for (count = HS_RUNOPTS2_VOLUME_DN; count <= HS_RUNOPTS2_NEXT; count++) {
			...
			hotspots[count].hl_h -= 1 * 8 * video.scale;
                ...
                #if defined(PLATFORM_DINGUX_A320)
		/* Resize runtime options hotspots */
		hotspots[HS_RUNOPTS3_RUNOPTS3].hit_x = runtime_options[3].xoffset;
		hotspots[HS_RUNOPTS3_RUNOPTS3].hit_y = runtime_options[3].yoffset;
		...
		hotspots[HS_RUNOPTS3_JOY_CFG_LTRIG].hit_y += 2.5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_LTRIG].hit_w = 3 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_RTRIG].hit_x += 25 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_RTRIG].hit_y += 2.5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_RTRIG].hit_w = 3 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_LEFT].hit_x += 4 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_LEFT].hit_y += 6.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_RIGHT].hit_x += 6 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_RIGHT].hit_y += 6.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_UP].hit_x += 5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_UP].hit_y += 5.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_DOWN].hit_x += 5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_DOWN].hit_y += 7.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_SELECT].hit_x += 4 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_SELECT].hit_y += 9.5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_SELECT].hit_w += 3.1 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_START].hit_x += 25 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_START].hit_y += 9.5 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_START].hit_w += 3.1 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_A].hit_x += 28 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_A].hit_y += 6.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_B].hit_x += 26 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_B].hit_y += 7.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_Y].hit_x += 24 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_Y].hit_y += 6.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_JOY_CFG_X].hit_x += 26 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_JOY_CFG_X].hit_y += 5.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_1].hit_x += 6 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_1].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_2].hit_x += 8 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_2].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_3].hit_x += 10 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_3].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_4].hit_x += 12 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_4].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_5].hit_x += 14 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_5].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_6].hit_x += 16 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_6].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_7].hit_x += 18 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_7].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_8].hit_x += 20 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_8].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_9].hit_x += 22 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_9].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_0].hit_x += 24 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_0].hit_y += 13.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_Q].hit_x += 6 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_Q].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_W].hit_x += 8 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_W].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_E].hit_x += 10 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_E].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_R].hit_x += 12 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_R].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_T].hit_x += 14 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_T].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_Y].hit_x += 16 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_Y].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_U].hit_x += 18 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_U].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_I].hit_x += 20 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_I].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_O].hit_x += 22 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_O].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_P].hit_x += 24 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_P].hit_y += 14.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_A].hit_x += 6 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_A].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_S].hit_x += 8 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_S].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_D].hit_x += 10 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_D].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_F].hit_x += 12 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_F].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_G].hit_x += 14 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_G].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_H].hit_x += 16 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_H].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_J].hit_x += 18 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_J].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_K].hit_x += 20 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_K].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_L].hit_x += 22 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_L].hit_y += 15.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_NEWLINE].hit_x += 24 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_NEWLINE].hit_y += 15.5 * 8 * video.scale;

		/* hotspots[HS_RUNOPTS3_KEY_SHIFT].hit_x += 0 * 8 * video.scale; */
		hotspots[HS_RUNOPTS3_KEY_SHIFT].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_Z].hit_x += 8 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_Z].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_X].hit_x += 10 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_X].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_C].hit_x += 12 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_C].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_V].hit_x += 14 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_V].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_B].hit_x += 16 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_B].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_N].hit_x += 18 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_N].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_M].hit_x += 20 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_M].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_DOT].hit_x += 22 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_DOT].hit_y += 16.5 * 8 * video.scale;

		hotspots[HS_RUNOPTS3_KEY_SPACE].hit_x += 24 * 8 * video.scale;
		hotspots[HS_RUNOPTS3_KEY_SPACE].hit_y += 16.5 * 8 * video.scale;
		...
		for (count = HS_RUNOPTS3_JOY_CFG_LTRIG; count <= HS_RUNOPTS3_EXIT; count++) {
			hotspots[count].hit_h = 2 * 8 * video.scale;
			if (count >= HS_RUNOPTS3_JOY_CFG_LEFT && 
			    count < HS_RUNOPTS3_BACK && 
			    count!=HS_RUNOPTS3_JOY_CFG_SELECT &&
			    count!=HS_RUNOPTS3_JOY_CFG_START && 
			    count!=HS_RUNOPTS3_KEY_SHIFT &&
			    count!=HS_RUNOPTS3_KEY_NEWLINE &&
			    count!=HS_RUNOPTS3_KEY_SPACE )	
				hotspots[count].hit_w = 1 * 8 * video.scale;
		}

                /* Set-up small keys */
		for (count = HS_RUNOPTS3_KEY_1; count <= HS_RUNOPTS3_KEY_SPACE; count++) {
			hotspots[count].hit_h = 1 * 8 * video.scale;
			hotspots[count].hit_w = 1 * 8 * video.scale;
			...
			hotspots[count].hl_w = hotspots[count].hit_w;
			hotspots[count].hl_h = hotspots[count].hit_h;
			hotspots[count].remap_id = count; /* show the hotspot while select */
		}


		/* Set-up the large keys [SHIFT], [NEWLINE] and [SPACE] */

		for(count = 0;count <=2;count++){
			int lk;
			if(count==0) lk=HS_RUNOPTS3_KEY_SHIFT;
			else if(count==1) lk=HS_RUNOPTS3_KEY_NEWLINE;
			else if(count==2) lk=HS_RUNOPTS3_KEY_SPACE;
		
		  	hotspots[lk].hit_w += 6 * 8 * video.scale;
		  	hotspots[lk].hl_w = hotspots[lk].hit_w;
			hotspots[lk].remap_id = lk; 
		}

		/* Set-up Dingoo Keys hl_x/y/w/h */
		for (count = HS_RUNOPTS3_JOY_CFG_LTRIG; count <= HS_RUNOPTS3_EXIT; count++) {
			hotspots[count].hl_x = hotspots[count].hit_x;
			hotspots[count].hl_y = hotspots[count].hit_y;
			hotspots[count].hl_w = hotspots[count].hit_w;
...
*/
		if (hotspots[count].gid != UNDEFINED &&
			...
			if (pressed ||
				...
				#if defined(PLATFORM_DINGUX_A320)
				(hotspots[count].gid == HS_GRP_VKEYB && selected) ||
				(hotspots[count].gid == HS_GRP_CTB && selected)) {
				#else
