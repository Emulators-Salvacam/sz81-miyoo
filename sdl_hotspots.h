...
#define HS_RUNOPTS0_CLOSE 70
#define HS_RUNOPTS0_SAVE 71
#define HS_RUNOPTS0_EXIT 72
#define HS_RUNOPTS0_NEXT 73
#else
...
#if defined(PLATFORM_MIYOO)
#define HS_RUNOPTS2_FULLS_YES 119
#define HS_RUNOPTS2_FULLS_NO 120
#define HS_RUNOPTS2_BACK 121
#define HS_RUNOPTS2_SAVE 122
...
#if defined(PLATFORM_MIYOO)
#define HS_RUNOPTS3_SAVE_GAME 144
#define HS_RUNOPTS3_EXIT 145
#else
#define HS_RUNOPTS3_EXIT 144
#endif

#if defined(PLATFORM_DINGUX_A320)
   #define HS_RUNOPTS3_KEY_1 199
   #define HS_RUNOPTS3_KEY_2 200
   #define HS_RUNOPTS3_KEY_3 201
   #define HS_RUNOPTS3_KEY_4 202
   #define HS_RUNOPTS3_KEY_5 203
   #define HS_RUNOPTS3_KEY_6 204
   #define HS_RUNOPTS3_KEY_7 205
   #define HS_RUNOPTS3_KEY_8 206
   #define HS_RUNOPTS3_KEY_9 207
   #define HS_RUNOPTS3_KEY_0 208

   #define HS_RUNOPTS3_KEY_Q 209
   #define HS_RUNOPTS3_KEY_W 210
   #define HS_RUNOPTS3_KEY_E 211
   #define HS_RUNOPTS3_KEY_R 212
   #define HS_RUNOPTS3_KEY_T 213
   #define HS_RUNOPTS3_KEY_Y 214
   #define HS_RUNOPTS3_KEY_U 215
   #define HS_RUNOPTS3_KEY_I 216
   #define HS_RUNOPTS3_KEY_O 217
   #define HS_RUNOPTS3_KEY_P 218

   #define HS_RUNOPTS3_KEY_A 219
   #define HS_RUNOPTS3_KEY_S 220
   #define HS_RUNOPTS3_KEY_D 221
   #define HS_RUNOPTS3_KEY_F 222
   #define HS_RUNOPTS3_KEY_G 223
   #define HS_RUNOPTS3_KEY_H 224
   #define HS_RUNOPTS3_KEY_J 225
   #define HS_RUNOPTS3_KEY_K 226
   #define HS_RUNOPTS3_KEY_L 227
   #define HS_RUNOPTS3_KEY_NEWLINE 228

   #define HS_RUNOPTS3_KEY_SHIFT 229
   #define HS_RUNOPTS3_KEY_Z 230
   #define HS_RUNOPTS3_KEY_X 231
   #define HS_RUNOPTS3_KEY_C 232
   #define HS_RUNOPTS3_KEY_V 233
   #define HS_RUNOPTS3_KEY_B 234
   #define HS_RUNOPTS3_KEY_N 235
   #define HS_RUNOPTS3_KEY_M 236
