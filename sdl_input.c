...
void sdl_keyboard_init(void) {
	...
	/* Set some default controls for DINGUX A320 platform */
#if defined(PLATFORM_DINGUX_A320)
	ctrl_remaps[DINGOO_REMAP_UP].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_UP].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_UP].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_UP].id = DINGOO_UP;
	ctrl_remaps[DINGOO_REMAP_UP].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_UP].remap_id = SDLK_7;

	ctrl_remaps[DINGOO_REMAP_DOWN].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_DOWN].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_DOWN].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_DOWN].id = DINGOO_DOWN;
	ctrl_remaps[DINGOO_REMAP_DOWN].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_DOWN].remap_id = SDLK_6;
        
	ctrl_remaps[DINGOO_REMAP_LEFT].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_LEFT].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_LEFT].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_LEFT].id = DINGOO_LEFT;
	ctrl_remaps[DINGOO_REMAP_LEFT].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_LEFT].remap_id = SDLK_5;
        
	ctrl_remaps[DINGOO_REMAP_RIGHT].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_RIGHT].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_RIGHT].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_RIGHT].id = DINGOO_RIGHT;
	ctrl_remaps[DINGOO_REMAP_RIGHT].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_RIGHT].remap_id = SDLK_8;
       
	ctrl_remaps[DINGOO_REMAP_A].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_A].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_A].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_A].id = DINGOO_A;
	ctrl_remaps[DINGOO_REMAP_A].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_A].remap_id = SDLK_0;

	ctrl_remaps[DINGOO_REMAP_B].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_B].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_B].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_B].id = DINGOO_B;
	ctrl_remaps[DINGOO_REMAP_B].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_B].remap_id = SDLK_9;

	ctrl_remaps[DINGOO_REMAP_X].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_X].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_X].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_X].id = DINGOO_X;
	ctrl_remaps[DINGOO_REMAP_X].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_X].remap_id = SDLK_RETURN;

	ctrl_remaps[DINGOO_REMAP_Y].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_Y].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_Y].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_Y].id = DINGOO_Y;
	ctrl_remaps[DINGOO_REMAP_Y].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_Y].remap_id = SDLK_y;

	ctrl_remaps[DINGOO_REMAP_L].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_L].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_L].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_L].id = DINGOO_L;
	ctrl_remaps[DINGOO_REMAP_L].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_L].remap_id = SDLK_1;

	ctrl_remaps[DINGOO_REMAP_R].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_R].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_R].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_R].id = DINGOO_R;
	ctrl_remaps[DINGOO_REMAP_R].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_R].remap_id = SDLK_2;

	ctrl_remaps[DINGOO_REMAP_SELECT].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_SELECT].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_SELECT].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_SELECT].id = DINGOO_SELECT;
	ctrl_remaps[DINGOO_REMAP_SELECT].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_SELECT].remap_id = SDLK_3;

	ctrl_remaps[DINGOO_REMAP_START].components = COMP_EMU;
	ctrl_remaps[DINGOO_REMAP_START].protected = TRUE;
	ctrl_remaps[DINGOO_REMAP_START].device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_START].id = DINGOO_START;
	ctrl_remaps[DINGOO_REMAP_START].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[DINGOO_REMAP_START].remap_id = SDLK_4;
	...
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_R;
	ctrl_remaps[index].remap_device = DEVICE_KEYBOARD;
	ctrl_remaps[index].remap_id = SDLK_a;
	ctrl_remaps[index].remap_mod_id = SDLK_LSHIFT;

	/* Active within dialog/ldfile/sstate/runopts */
	ctrl_remaps[++index].components = COMP_DIALOG | COMP_LDFILE | COMP_SSTATE | COMP_RUNOPTS_ALL | COMP_VKEYB ;
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_LEFT;
	...
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_RIGHT;
	ctrl_remaps[index].remap_device = DEVICE_CURSOR;
	...
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_B;
	ctrl_remaps[index].remap_device = DEVICE_CURSOR;
	ctrl_remaps[index].remap_id = CURSOR_HIT;

	/* Active within sstate/runopts */
	ctrl_remaps[++index].components = COMP_SSTATE | COMP_RUNOPTS_ALL | COMP_VKEYB;
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_UP;
	ctrl_remaps[index].remap_device = DEVICE_CURSOR;
	...
	ctrl_remaps[index].protected = TRUE;
	ctrl_remaps[index].device = DEVICE_KEYBOARD;
	ctrl_remaps[index].id = DINGOO_DOWN;
	ctrl_remaps[index].remap_device = DEVICE_CURSOR;
...
/*				printf("hs:%d\n Button pressed: %s\n",hs_currently_selected,keysyms[hs_currently_selected]); // This causes core dump in tests*/
				...
				/*  printf("flags:%d\n",hotspots[ ZX_key_to_id(hs_currently_selected) ].flags); */
#endif
#if defined(PLATFORM_DINGUX_A320)   
				if(hs_currently_selected>=HS_RUNOPTS3_JOY_CFG_LTRIG &&
						hs_currently_selected<=HS_RUNOPTS3_JOY_CFG_X){
					dingoo_selected_key=hs_currently_selected;
					key_map_status|=STATUS_KEY_MAP_DINGOO;
				}else if(hs_currently_selected>=HS_RUNOPTS3_KEY_1 &&
						hs_currently_selected<=HS_RUNOPTS3_KEY_SPACE){
					ZX_selected_key=hs_currently_selected;
					key_map_status|=STATUS_KEY_MAP_ZX;
				}
				if(key_map_status==(STATUS_KEY_MAP_ZX ^ STATUS_KEY_MAP_DINGOO)){
					key_map_status=STATUS_KEY_MAP_NULL;
#if defined(DEBUG_DINGUX_A320)
					/*   printf("loaded file:%s\n",load_file_dialog.loaded); */
					printf("key_map_status: %d\n",key_map_status);
					printf("OLD: ctrl_remaps[%d].remap_id=%d\n",dingoo_selected_key,ctrl_remaps[dingoo_selected_key].remap_id);
					printf("NEW: ctrl_remaps[%d].remap_id=%d\n",dingoo_selected_key,ZX_selected_key);
#endif
					ctrl_remaps[key_to_keymap(dingoo_selected_key)].remap_id=ZX_key_to_id(ZX_selected_key);  
				}
#endif
...
//						SDL_PushEvent(&virtualevent);
					...
					*/
					...
					if (hs_currently_selected == HS_RUNOPTS3_JOY_CFG_LTRIG) {
						...
						hotspots[HS_RUNOPTS3_JOY_CFG_B].flags |= HS_PROP_SELECTED;
							...
							(hs_currently_selected == HS_RUNOPTS3_KEY_2) ||
							(hs_currently_selected == HS_RUNOPTS3_KEY_3) ||
						...
						hotspots[HS_RUNOPTS3_JOY_CFG_SELECT].flags |= HS_PROP_SELECTED;
							...
							(hs_currently_selected == HS_RUNOPTS3_KEY_0) ) {
						hotspots[HS_RUNOPTS3_JOY_CFG_START].flags |= HS_PROP_SELECTED;
					} else if (hs_currently_selected == HS_RUNOPTS3_BACK ) {
						hotspots[HS_RUNOPTS3_KEY_SHIFT].flags |= HS_PROP_SELECTED;
					} else if (hs_currently_selected == HS_RUNOPTS3_EXIT ) {
						hotspots[HS_RUNOPTS3_KEY_SPACE].flags |= HS_PROP_SELECTED;
					} else if ((hs_currently_selected>=HS_RUNOPTS3_KEY_Q) &&
						   (hs_currently_selected<=HS_RUNOPTS3_KEY_SPACE)){
						hotspots[hs_currently_selected-10].flags |= HS_PROP_SELECTED;
				...
				if (get_active_component() == COMP_SSTATE) {
					...
					if (hs_currently_selected == HS_RUNOPTS3_BACK ||
					...
					} else if ((hs_currently_selected >= HS_RUNOPTS3_KEY_SHIFT) &&
						   (hs_currently_selected <= HS_RUNOPTS3_KEY_Z)) {
						hotspots[HS_RUNOPTS3_BACK].flags |= HS_PROP_SELECTED;

					} else if ((hs_currently_selected >= HS_RUNOPTS3_KEY_X) &&
						   (hs_currently_selected <= HS_RUNOPTS3_KEY_V)) {
						hotspots[HS_RUNOPTS3_SAVE].flags |= HS_PROP_SELECTED;
					#if defined (PLATFORM_MIYOO)
					} else if ((hs_currently_selected >= HS_RUNOPTS3_KEY_B) &&
						   (hs_currently_selected <= HS_RUNOPTS3_KEY_N)) {
						hotspots[HS_RUNOPTS3_SAVE_GAME].flags |= HS_PROP_SELECTED;

					} else if ((hs_currently_selected >= HS_RUNOPTS3_KEY_M) &&
						   (hs_currently_selected <= HS_RUNOPTS3_KEY_SPACE)) {
						hotspots[HS_RUNOPTS3_EXIT].flags |= HS_PROP_SELECTED;
						...
						hotspots[HS_RUNOPTS3_EXIT].flags |= HS_PROP_SELECTED;
						   ...
						   (hs_currently_selected <= HS_RUNOPTS3_KEY_NEWLINE)) {
						hotspots[hs_currently_selected+10].flags |= HS_PROP_SELECTED;
						...
						hotspots[HS_RUNOPTS3_KEY_0].flags |= HS_PROP_SELECTED;
					}
					#else
					if (hs_currently_selected == HS_RUNOPTS3_BACK ||
						hs_currently_selected == HS_RUNOPTS3_SAVE) {
				...
				if (get_active_component() == COMP_DIALOG) {
					...
					hotspots[hs_currently_selected].flags &= ~HS_PROP_SELECTED;
					/* dingoo key remap - left*/
					#if defined(PLATFORM_DINGUX_A320)
					if(hs_currently_selected == HS_RUNOPTS3_KEY_1){
						hotspots[HS_RUNOPTS3_KEY_0].flags |= HS_PROP_SELECTED;

					}if ((hs_currently_selected >= HS_RUNOPTS3_KEY_2) && 
					     (hs_currently_selected <= HS_RUNOPTS3_KEY_SPACE)) {
						hotspots[hs_currently_selected-1].flags |= HS_PROP_SELECTED;

					} else if((hs_currently_selected == HS_RUNOPTS3_SAVE)||
							#if defined (PLATFORM_MIYOO)
					          (hs_currently_selected == HS_RUNOPTS3_SAVE_GAME) ||
					        #endif
					          (hs_currently_selected == HS_RUNOPTS3_EXIT)){
							hotspots[hs_currently_selected-1].flags |= HS_PROP_SELECTED;
				...
				if (get_active_component() == COMP_DIALOG) {
					...
					#if defined(PLATFORM_DINGUX_A320)
					if(hs_currently_selected >= HS_RUNOPTS3_KEY_1 &&
				  		hs_currently_selected <= HS_RUNOPTS3_KEY_DOT  ){
						hotspots[hs_currently_selected + 1].flags |= HS_PROP_SELECTED;

					}else if(hs_currently_selected == HS_RUNOPTS3_KEY_SPACE){
						hotspots[HS_RUNOPTS3_KEY_SHIFT].flags |= HS_PROP_SELECTED;
					}if(hs_currently_selected == HS_RUNOPTS3_JOY_CFG_LTRIG){
						hotspots[HS_RUNOPTS3_JOY_CFG_RTRIG].flags |= HS_PROP_SELECTED;
					}else if(hs_currently_selected == HS_RUNOPTS3_JOY_CFG_RTRIG){
...
void write_mapping_game(void) {
	...
	strcpy(notification.text, "Mapping saved for this game");
...
int key_to_keymap(int keycode) {
	...
	if(keycode==HS_RUNOPTS3_JOY_CFG_UP)
		keymap=DINGOO_REMAP_UP;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_DOWN)
		keymap=DINGOO_REMAP_DOWN;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_LEFT)
		keymap=DINGOO_REMAP_LEFT;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_RIGHT)
		keymap=DINGOO_REMAP_RIGHT;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_A)
		keymap=DINGOO_REMAP_A;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_B)
		keymap=DINGOO_REMAP_B;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_Y)
		keymap=DINGOO_REMAP_Y;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_X)
		keymap=DINGOO_REMAP_X;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_SELECT)
		keymap=DINGOO_REMAP_SELECT;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_START)
		keymap=DINGOO_REMAP_START;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_LTRIG)
		keymap=DINGOO_REMAP_L;
	else if(keycode==HS_RUNOPTS3_JOY_CFG_RTRIG)
		keymap=DINGOO_REMAP_R;
	return keymap;
}
...
int ZX_key_to_id(int zxkey) {
    ...
    if(zxkey==HS_RUNOPTS3_KEY_1){ 
	    id=SDLK_1;
    }else if(zxkey==HS_RUNOPTS3_KEY_2){ 
	    id=SDLK_2;
    }else if(zxkey==HS_RUNOPTS3_KEY_3){ 
	    id=SDLK_3;
    }else if(zxkey==HS_RUNOPTS3_KEY_4){ 
	    id=SDLK_4;
    }else if(zxkey==HS_RUNOPTS3_KEY_5){ 
	    id=SDLK_5;
    }else if(zxkey==HS_RUNOPTS3_KEY_6){ 
	    id=SDLK_6;
    }else if(zxkey==HS_RUNOPTS3_KEY_7){ 
	    id=SDLK_7;
    }else if(zxkey==HS_RUNOPTS3_KEY_8){ 
	    id=SDLK_8;
    }else if(zxkey==HS_RUNOPTS3_KEY_9){ 
	    id=SDLK_9;
    }else if(zxkey==HS_RUNOPTS3_KEY_0){ 
	    id=SDLK_0;
    }else if(zxkey==HS_RUNOPTS3_KEY_Q){ 
	    id=SDLK_q;
    }else if(zxkey==HS_RUNOPTS3_KEY_W){ 
	    id=SDLK_w;
    }else if(zxkey==HS_RUNOPTS3_KEY_E ){ 
	    id=SDLK_e;
    }else if(zxkey==HS_RUNOPTS3_KEY_R ){ 
	    id=SDLK_r;
    }else if(zxkey==HS_RUNOPTS3_KEY_T ){ 
	    id=SDLK_t;
    }else if(zxkey==HS_RUNOPTS3_KEY_Y){ 
	    id=SDLK_y;
    }else if(zxkey==HS_RUNOPTS3_KEY_U ){ 
	    id=SDLK_u;
    }else if(zxkey==HS_RUNOPTS3_KEY_I ){ 
	    id=SDLK_i;
    }else if(zxkey==HS_RUNOPTS3_KEY_O ){ 
	    id=SDLK_o;
    }else if(zxkey==HS_RUNOPTS3_KEY_P ){ 
	    id=SDLK_p;
    }else if(zxkey==HS_RUNOPTS3_KEY_A ){ 
	    id=SDLK_a;
    }else if(zxkey==HS_RUNOPTS3_KEY_S ){ 
	    id=SDLK_s;
    }else if(zxkey==HS_RUNOPTS3_KEY_D ){ 
	    id=SDLK_d;
    }else if(zxkey==HS_RUNOPTS3_KEY_F ){ 
	    id=SDLK_f;
    }else if(zxkey==  HS_RUNOPTS3_KEY_G ){ 
	    id=SDLK_g;
    }else if(zxkey==  HS_RUNOPTS3_KEY_H ){ 
	    id=SDLK_h;
    }else if(zxkey==  HS_RUNOPTS3_KEY_J ){ 
	    id=SDLK_j;
    }else if(zxkey==  HS_RUNOPTS3_KEY_K ){ 
	    id=SDLK_k;
    }else if(zxkey==  HS_RUNOPTS3_KEY_L ){ 
	    id=SDLK_l;
    }else if(zxkey==  HS_RUNOPTS3_KEY_NEWLINE ){ 
	    id=SDLK_RETURN;
    }else if(zxkey==  HS_RUNOPTS3_KEY_SHIFT ){ 
	    id=SDLK_LSHIFT;
    }else if(zxkey==  HS_RUNOPTS3_KEY_Z ){ 
	    id=SDLK_z;
    }else if(zxkey==  HS_RUNOPTS3_KEY_X ){ 
	    id=SDLK_x;
    }else if(zxkey==  HS_RUNOPTS3_KEY_C ){ 
	    id=SDLK_c;
    }else if(zxkey==  HS_RUNOPTS3_KEY_V ){ 
	    id=SDLK_v;
    }else if(zxkey==  HS_RUNOPTS3_KEY_B ){ 
	    id=SDLK_b;
    }else if(zxkey==  HS_RUNOPTS3_KEY_N ){ 
	    id=SDLK_n;
    }else if(zxkey==  HS_RUNOPTS3_KEY_M ){ 
	    id=SDLK_m;
    }else if(zxkey==  HS_RUNOPTS3_KEY_DOT){ 
	    id=SDLK_PERIOD;
    }else if(zxkey==  HS_RUNOPTS3_KEY_SPACE){ 
	    id=SDLK_SPACE;
    } 
    return id;
}
